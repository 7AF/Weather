...
public class WeatherHttpClient {
    ...
    private static String APIKEY = "&APPID=5754edde5ef8db4aa75e56f36e7424de";
    private static String FAPIKEY = "&APPID=4678ce7a6162c48014bae832763104d2";
    ...
    public String getForecastWeatherData(String location, String lang, String sForecastDayNum) {
        DayForecastFragment.city=location;
        HttpURLConnection con = null;
        InputStream is = null;
        int forecastDayNum = Integer.parseInt(sForecastDayNum);
        try {
            // Forecast
            String url = BASE_FORECAST_URL + location + FAPIKEY;
            if (lang != null)
                url = url + "&lang=" + lang;
