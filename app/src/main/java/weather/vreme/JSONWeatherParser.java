...
public class JSONWeatherParser {
    ...
    public static WeatherForecast getForecastWeather(String data) throws JSONException {
        ...
        for (int i = 0; i < jArr.length(); i++) {
            ...
            df.weather.currentCondition1.setPressure1((float) jDayForecast.getDouble("pressure"));
            df.weather.currentCondition1.setHumidity1((float) jDayForecast.getDouble("humidity"));

            JSONArray jWeatherArr = jDayForecast.getJSONArray("weather");
            JSONObject jWeatherObj = jWeatherArr.getJSONObject(0);
            Weather.currentCondition.setWeatherId(getInt("id", jWeatherObj));
            df.weather.currentCondition1.setDescr1(getString("description", jWeatherObj));
            Weather.currentCondition.setCondition(getString("main", jWeatherObj));
            df.weather.currentCondition1.setIcon1(getString("icon", jWeatherObj));
